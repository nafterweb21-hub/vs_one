          ...
          <div className="grid gap-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <input
                ...
                className={`mt-1.5 w-full px-3.5 py-2.5 rounded-xl border text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500/20 focus:border-cyan-500 transition-all text-zinc-900 dark:text-zinc-100 bg-zinc-50/50 dark:bg-zinc-950 ${formErrors.code
