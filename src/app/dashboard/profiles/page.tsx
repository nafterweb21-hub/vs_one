...
export default function ProfilesDashboard() {
  ...
  const inactiveCount = currencyStats.total - currencyStats.active;
      ...
      <div className="relative rounded-2xl overflow-hidden border border-blue-500/10 bg-gradient-to-r from-zinc-950 via-zinc-900 to-zinc-950 p-8 lg:p-10 text-white shadow-xl">
        ...
        <div className="relative z-10 max-w-3xl space-y-4">
          ...
          <p className="text-zinc-400 text-sm lg:text-base leading-relaxed">
            Manage multi-currency exchange rates, set default currencies, and configure financial denominations for the entire system.
          </p>
        </div>
      </div>
        ...
        >
          ...
          <div className="flex items-start gap-4">
            <div className="p-3 rounded-lg bg-zinc-50 dark:bg-zinc-950 border border-zinc-200/60 dark:border-zinc-800/60 text-zinc-500 dark:text-zinc-400 group-hover:bg-blue-600 group-hover:border-blue-600 group-hover:text-white transition-all duration-300">
              <Coins size={24} className="transform group-hover:scale-110 transition-transform duration-300" />
            </div>

            <div className="flex-1 space-y-1">
              <div className="flex items-center justify-between">
                <h4 className="font-bold text-lg text-zinc-950 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                  Currency Master
                </h4>
              ...
              <p className="text-sm text-zinc-400 dark:text-zinc-500 leading-relaxed">
                Add, edit, and manage currency codes (USD, SGD, INR, MYR), exchange rates with 3-decimal precision, and set default currency for your enterprise.
              </p>
            </div>
          </div>

          {/* Footer card metrics */}
          <div className="mt-5 pt-3.5 border-t border-zinc-100 dark:border-zinc-800/80 flex items-center justify-between text-[11px] font-semibold">
